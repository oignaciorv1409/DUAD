...
def create_student():
        ...
        #Replace student_profile dict for student_profile_object
        student_profile_object = Student(
                full_name,
                section,
                spanish_grade,
                english_grade,
...
def calculate_student_average(student_obj):
        sum_total = (
                student_obj.spanish_grade
                + student_obj.english_grade
                + student_obj.social_studies_grade
                + student_obj.science_grade
        )
